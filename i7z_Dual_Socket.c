    ...
    for (;;)
    {
        ...
        if (run_times != 0) {
            ...
            print_i7z_socket_stdout(
                    ...
                    cpu_freq_cpuinfo, 
                    one_second_sleep, 
                    TURBO_MODE, HT_ON_str, 
                    &kk_1, old_val_CORE[socket_num],
